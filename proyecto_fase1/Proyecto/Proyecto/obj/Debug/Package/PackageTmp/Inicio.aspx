    ...
    <div>
        <asp:Panel ID="PanelCliente" runat="server">
            <center style="margin-left: 40px">
                ...
                &nbsp;
                <asp:DropDownList ID="DropDownList4" runat="server" Visible="false"></asp:DropDownList>
                <br />
                <asp:Label ID="Label19" runat="server" Text="Fila: " Visible="false"></asp:Label>
                &nbsp;
                <asp:DropDownList ID="DropDownList5" runat="server" Visible="false"></asp:DropDownList>
                <br />
